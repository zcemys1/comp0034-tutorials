...
1. [Create a basic Dash app and add a layout with HTML elements](1-2-dash-app-layout.md)
2. [Enable Dash Bootstrap Components CSS styling for the Dash app](1-3-add-bootstrap.md)
3. [Add the 12 column layout to the Dash app](1-4-12columnlayout.md)
4. [Add HTML components into the layout](1-5-add-html-components.md)
5. [(optional) Create a multi-page version of the app](1-6-multipage-app.md)
...
[Next activity](1-2-dash-app-layout.md)